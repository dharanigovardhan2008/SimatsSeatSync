      ...
      <div className="flex flex-wrap gap-3 mb-3">
        ...
        {images.length < max && (
          <button
            ...
            disabled={uploading}
            className="w-24 h-24 rounded-2xl bg-white/50 backdrop-blur-md shadow-[inset_6px_6px_10px_rgb(163,177,198,0.6),inset_-6px_-6px_10px_rgba(255,255,255,0.5)] flex items-center justify-center text-[#3B9EFF] text-3xl disabled:opacity-50"
          >
            {uploading ? '…' : '+'}
          </button>
        )}
